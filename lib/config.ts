...
export const API_ROUTES = {
  ...
  feeAssignments: "/api/v1/fees/assignments",
  feeAssignmentsPreview: "/api/v1/fees/assignments/preview",
  studentBills: "/api/v1/fees/bills",
  studentBillsGenerate: "/api/v1/fees/bills/generate",
  ...
  feeAdjustment: (adjustmentId: string) => `/api/v1/fees/adjustments/${adjustmentId}`,
  financeOverview: "/api/v1/fees/overview",
  financeCollections: "/api/v1/fees/reports/collections",
  financeOutstanding: "/api/v1/fees/reports/outstanding",
  financeOutstandingCsv: "/api/v1/fees/reports/outstanding.csv",
  financeAuditLogs: "/api/v1/fees/audit-logs",
  ...
  skillTypesCopy: "/api/v1/settings/skill-types/copy",
